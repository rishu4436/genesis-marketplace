  ...
  return (
    <section className="relative flex min-h-[100svh] flex-col justify-center overflow-hidden">
      <motion.div style={{ scale, opacity, y }} className="mx-auto w-full max-w-6xl px-5 py-28 sm:px-8 sm:py-32">
        ...
        >
          Find. Compare. Hire. Autonomous agents on BNB Smart Chain —
          where 200,000+ ERC-8004 identities finally get a home.
        </motion.p>
        <motion.div
        ...
        >
          <Link href="/shop" className="btn-primary !px-6 !py-3 !text-[0.95rem]">
          ...
          <FadeIn>
            ...
            <h2 className="mt-5 max-w-3xl font-display text-[clamp(1.9rem,4.5vw,3.25rem)] font-bold leading-[1.08] tracking-tight text-white">
              ...
              <span className="text-white/40">
                Almost impossible to find the right one.
              </span>
            </h2>
          </FadeIn>
