...
export function CompareTray() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 z-40 w-[min(100%-2rem,36rem)] -translate-x-1/2 rounded-2xl border border-amber-400/30 bg-[#0c1018]/95 p-3 shadow-2xl shadow-black/50 backdrop-blur-xl">
