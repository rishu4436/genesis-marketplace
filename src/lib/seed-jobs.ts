...
export const SEED_JOBS: HireJob[] = [
  ...
  weekHs as HireJob,
  {
    ...
    quote: {
      ...
      notes: "Soft-hire · RangeKeeper — no on-chain lock",
      live: false,
    },
    deliverable: {
  ...
  },
  {
    ...
    quote: {
      ...
      notes: "Soft-hire · YieldRouter — no on-chain lock",
      live: false,
    },
    deliverable: {
  ...
  },
  {
    ...
    status: "delivered",
    chainId: 56,
    tokenId: "genesis:health-sentinel",
    ...
    quote: {
      ...
      notes: "Soft-hire · HealthSentinel — no on-chain lock",
      live: false,
    },
    deliverable: {
